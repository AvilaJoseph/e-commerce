        ...
        <section className="flex flex-col w-full py-3 gap-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="grid grid-rows-1 md:grid-rows-2 gap-4">
                    <div className="bg-[#efefef] flex flex-col rounded-2xl px-8 py-3">
                ...
                <div className="grid grid-rows-1 md:grid-rows-2 gap-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-[#efefef] flex flex-col rounded-2xl px-8 py-3">s</div>
                        <div className="bg-[#efefef] flex flex-col rounded-2xl px-8 py-3">s</div>
                    </div>
                    <div className="bg-[#efefef] flex flex-col rounded-2xl px-8 py-3">sd</div>
                </div>
            </div>
        </section >
    )
